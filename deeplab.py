...
def ASPP(tensor):
    ...
    y_pool = BatchNormalization(name=f'bn_1', epsilon=1e-5)(y_pool)
    ...
    y_1 = BatchNormalization(name=f'bn_2', epsilon=1e-5)(y_1)
    ...
    y_6 = BatchNormalization(name=f'bn_3', epsilon=1e-5)(y_6)
    ...
    y_12 = BatchNormalization(name=f'bn_4', epsilon=1e-5)(y_12)
    ...
    y_18 = BatchNormalization(name=f'bn_5', epsilon=1e-5)(y_18)
    ...
    y = BatchNormalization(name=f'bn_final', epsilon=1e-5)(y)
...
def DeepLabV3Plus(img_height, img_width, nclasses=66):
    ...
    x_b = BatchNormalization(name=f'bn_low_level_projection', epsilon=1e-5)(x_b)
    ...
    x = BatchNormalization(name=f'bn_decoder_1', epsilon=1e-5)(x)
    x = Activation('relu', name='activation_decoder_1')(x)

    x = Conv2D(filters=256, kernel_size=3, padding='same', activation='relu',
               kernel_initializer='he_normal', name='decoder_conv2d_2')(x)
    x = BatchNormalization(name=f'bn_decoder_2', epsilon=1e-5)(x)
